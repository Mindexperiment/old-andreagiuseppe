   ...
   <div class="columns is-multiline is-mobile">
    ...
    <div class="column is-12-mobile is-half-tablet is-one-third-desktop">
     <figure class="image is-3by2">
      <img src="{{ asset( 'images/layout/cmigea.jpg' ) }}" class="project-thumb" />
      <figcaption>
    ...
    <div class="column is-12-mobile is-half-tablet is-one-third-desktop">
     <figure class="image is-3by2">
      <img src="{{ asset( 'images/layout/sartori.jpg' ) }}" class="project-thumb" />
      <figcaption>
    ...
    <div class="column is-12-mobile is-half-tablet is-one-third-desktop">
     <figure class="image is-3by2">
      <img src="{{ asset( 'images/layout/kaleskop.jpg' ) }}" class="project-thumb" />
      <figcaption>
